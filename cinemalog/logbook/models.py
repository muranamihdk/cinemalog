...
class Movie(models.Model):
    ...
    img_url30 = models.URLField("Height30画像URL", max_length=300, blank=True)
    img_url60 = models.URLField("Height60画像URL", max_length=300, blank=True)
    img_url100 = models.URLField("Height100画像URL", max_length=300, blank=True)
